          ...
          <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div
                  ...
                  className={`p-4 rounded-2xl border transition-all cursor-pointer flex flex-col justify-between space-y-3 ${
                    selectedHours === 3
                      ? "bg-[#FDF7F5] border-2 border-purple-600 shadow-xs"
                      : "bg-white border-purple-100/80 hover:bg-[#FAFAFD]"
                  }`}
                >
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      <h4 className="font-outfit font-bold text-lg text-[#171A19]">
                        3 Hours
                      </h4>
            ...
            <div className="bg-white rounded-3xl p-5 border border-purple-100/80 shadow-xs space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="px-3 py-1 rounded-full bg-[#FAF0E6] text-purple-700 font-bold text-xs border border-[#F6D0C7]">
            ...
            <div className="bg-white rounded-3xl p-5 border border-purple-100/80 shadow-xs space-y-3 text-xs">
              ...
              <div className="space-y-2 text-[#555C58]">
                ...
                <div className="flex justify-between items-baseline font-bold text-[#171A19] pt-2 border-t border-[#F0EEE7] text-sm">
                  ...
                  <div className="text-right">
                    <span className="text-lg font-outfit text-purple-700">
                      ₹{totalPrice.toLocaleString("en-IN")}
                    </span>
                    <div className="text-[10px] font-normal text-[#737A76]">
            ...
            {/* Bottom Reminder */}
            <div className="p-3 bg-[#FAFAFD] rounded-2xl border border-[#EDEAE1] text-[11px] text-[#555C58] flex items-center gap-2">
            ...
            <div className="bg-white rounded-3xl p-6 border border-purple-100/80 shadow-lg space-y-5">
              ...
              <div className="space-y-3 text-xs text-[#555C58]">
                ...
                <div>
                  ...
                  <div className="font-semibold text-purple-700 flex items-center gap-1.5 mt-0.5">
                ...
                <div>
                  ...
                  <div className="w-full bg-[#FAFAFD] h-2 rounded-full overflow-hidden border border-[#EDEAE1]">
                    <div
              ...
              <div className="p-3.5 bg-[#FAFAFD] rounded-2xl border border-[#EDEAE1] flex items-center justify-between">
                <div>
                  <div className="text-[10px] font-bold uppercase text-[#737A76]">
                    Total Estimated Cost
                  </div>
                  <div className="text-2xl font-outfit font-bold text-[#171A19]">
                    ₹{totalPrice.toLocaleString("en-IN")}
                  </div>
                </div>
              ...
              <div className="p-3 bg-[#FAFAFD] rounded-xl border border-[#EDEAE1] flex items-center justify-between text-xs">
                ...
                <button
                  ...
                  className="px-2.5 py-1 bg-white border border-purple-100/80 rounded-lg text-[11px] font-semibold text-[#171A19] hover:bg-gray-50 cursor-pointer"
                >
                  Chat Desk
                </button>
              </div>
