          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-[#555C58]">
                Movie CoFriend • Kolkata • <span className="text-[#8F6200] font-medium">IMAX & Arthouse Film Specialist</span>
              </div>
            </div>
          </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-2 text-xs">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl border font-semibold transition-all cursor-pointer ${
                    quickSuggestion === "today"
                      ? "bg-[#FAF9F5] border-[#9E331A] text-[#9E331A]"
                      : "bg-white border-[#E7E4DC] text-[#555C58]"
                  }`}
                >
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-white border border-[#E7E4DC] text-[#555C58] font-semibold hover:bg-[#FAF9F5] transition-all cursor-pointer"
                >
                  This Monday (16 Dec)
                </button>
            ...
            <div className="bg-white rounded-3xl p-5 sm:p-6 border border-[#E7E4DC] shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-[#F0EEE7]">
                ...
                <div className="flex items-center gap-1">
                  <button className="p-1.5 rounded-lg border border-[#E7E4DC] hover:bg-[#FAF9F5] text-[#555C58]">
                  ...
                  return (
                    <button
                      ...
                      className={`p-2.5 rounded-2xl text-center transition-all flex flex-col items-center justify-between min-h-[62px] cursor-pointer ${
                        isSelected
                          ? "bg-[#9E331A] text-white shadow-md scale-102"
                          : isPast
                          ? "bg-[#FAF9F5] text-stone-300 opacity-60 cursor-not-allowed"
                          : isBooked
                          ? "bg-[#F5F5F0] text-stone-400 cursor-not-allowed"
                          : item.d === 14
                          ? "bg-[#FAF0E6] text-[#9E331A] border border-[#F6D0C7]"
              ...
              <div className="pt-3 border-t border-[#F2EFE8] flex flex-wrap items-center justify-between gap-2 text-[11px] text-[#737A76]">
                <div className="flex items-center gap-1.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#9E331A]" />
              ...
              <div className="pt-2 border-t border-[#D9DFD2]">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    >
                      <MapPin className="w-3 h-3 text-[#9E331A]" />
                      <span>{venue}</span>
                    </span>
                  ))}
                </div>
          ...
          <div className="lg:col-span-5 sticky top-24 space-y-4">
            <div className="bg-white rounded-3xl p-6 border border-[#E7E4DC] shadow-lg space-y-5">
              ...
              {/* Next Step Notice */}
              <div className="p-2.5 rounded-xl bg-[#FAF9F5] border border-[#EDEAE1] text-[11px] text-[#555C58] flex items-center gap-2">
              ...
              <div className="space-y-1.5 pt-2 border-t border-[#F2EFE8] text-[10.5px] text-[#555C58]">
                ...
                <div className="flex items-center gap-1.5">
                  <Info className="w-3.5 h-3.5 text-[#9E331A] shrink-0" />
                  <span>
              ...
              {/* Live Demand Ticker */}
              <div className="p-2 rounded-lg bg-[#FAF7EE] border border-[#EAE5D8] text-[10.5px] text-[#8F6200] flex items-center gap-1.5">
